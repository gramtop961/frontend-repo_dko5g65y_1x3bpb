    ...
    <section className="relative min-h-[90vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-7xl flex-col items-center justify-center px-6 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/40 px-3 py-1 text-xs text-zinc-300 shadow-lg"
        >
        ...
        <motion.h1
          ...
          className="mt-6 bg-gradient-to-br from-white to-zinc-300 bg-clip-text text-5xl font-bold tracking-tight text-transparent sm:text-6xl"
        >
        ...
        >
          <motion.button
            whileHover={{ y: -3 }}
            whileTap={{ y: 0 }}
            className="rounded-lg bg-red-600 px-6 py-3 text-sm font-medium text-white shadow-lg shadow-red-600/20 transition-colors hover:bg-red-500"
          >
            Explore Games
          </motion.button>
          <motion.button
            whileHover={{ y: -3 }}
            whileTap={{ y: 0 }}
            className="rounded-lg border border-white/10 px-6 py-3 text-sm text-zinc-200 transition-colors hover:bg-white/5"
          >
            Watch Trailer
          </motion.button>
        </motion.div>
